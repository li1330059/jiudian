...
/***/ 158:
/*!***********************************************************************!*\
  !*** D:/work/GitHub/jiudian/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \***********************************************************************/
...
/***/ 159:
/*!****************************************************!*\
  !*** D:/work/GitHub/jiudian/pages/index/index.vue ***!
  \****************************************************/
/*! no static exports found */
...
/***/ 160:
/*!***********************************************************************************!*\
  !*** D:/work/GitHub/jiudian/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***********************************************************************************/
...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.tuis, function (item, index) {
    var $orig = _vm.__get_orig(item)
    var g0 = index % 2 == 0 ? _vm.tuis.length : null
    return {
      $orig: $orig,
      g0: g0,
    }
...
/***/ 162:
/*!*****************************************************************************!*\
  !*** D:/work/GitHub/jiudian/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 163:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/work/GitHub/jiudian/pages/index/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var serviceDialog = function serviceDialog() {
  __webpack_require__.e(/*! require.ensure | components/serviceDialog3 */ "components/serviceDialog3").then((function () {
    return resolve(__webpack_require__(/*! @/components/serviceDialog3.vue */ 517));
    ...
    detail: function detail(id) {
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          console.log(res);
          _this.room = res.data;
          _this.room["price"] = _this.room.dj * _this.allDate;
          _this.room["arrs"] = _this.room.tp.split("|");
          console.log(_this.room.arrs);
          // this.lbb()
    ...
    weather: function weather() {
      ...
      uni.request({
        ...
        success: function success(res) {
          console.log("天气");
          console.log(res);
          _this2.wth = res.data.lives;
          console.log(_this2.wth);
        }
      });
    },
    tc: function tc() {
    ...
    tui: function tui() {
      ...
      uni.request({
        ...
        success: function success(res) {
          console.log("推荐");
          console.log(res);
          _this4.tuis = res.data;
          for (var i = 0; i < _this4.tuis.length; i++) {
            _this4.tuis[i]["arrs"] = _this4.tuis[i].tp.split("|");
          }
          console.log(_this4.tuis);
        }
      });
    }
  }
...
/***/ 164:
/*!*************************************************************************************!*\
  !*** D:/work/GitHub/jiudian/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
