<template>
	<view class="tcc" :style="{ height: screenHeight }">
		<view class="hdd">
				...
				<view style="font-size: 34rpx; color: #fff; margin-left: -60rpx;">套餐</view>	
		...
		<view class="jpkc">
			...
			<view class="dingdan-msg"  :class="{active:flag}">
				<view class="jpkcContent">
					<ul>
						<li  @click="kcc(item.id,item.title)" v-for="(item,index) in works" :key="index">
...
.tcc{
	...
	background: url("https://jhd.wangshangquan.top/static/img/tcbg.png") no-repeat center center;
