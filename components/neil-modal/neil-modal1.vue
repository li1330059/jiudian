<template>
    <view class="neil-modal" @touchmove.stop.prevent="bindTouchmove" :class="{'neil-modal--show':isOpen}">
        ...
        <view class="neil-modal__container">
			...
			<view class="iimgg" @click="clickLeftt"><image style="width: 40rpx; height: 40rpx; margin-top: 20rpx; margin-left: 20rpx;margin-right: 200rpx;"  :src="imgurl"></image></view>
			{{title}}</view>
...
<style lang="scss">
    $bg-color-mask:rgba(0, 0, 0, 0.1); //遮罩颜色
